...
// node_modules/@strapi/upload/dist/_chunks/index-BwEfHu6y.mjs
...
import "/Users/alexk/Desktop/project/strapi-admin/node_modules/cropperjs/dist/cropper.css";
...
var DropdownIndicator3 = ({ innerProps }) => {
  return (0, import_jsx_runtime.jsx)(CarretBox, { paddingRight: 3, ...innerProps, children: (0, import_jsx_runtime.jsx)(ForwardRef$4D, {}) });
};
...
var PreviewBox = ({
  ...
  const handleCropping = async () => {
    var _a2;
    const nextAsset = { ...asset, width, height, folder: (_a2 = asset.folder) == null ? void 0 : _a2.id };
  ...
  const handleDuplication = async () => {
    ...
    await upload({ name: file.name, rawFile: file }, (_a2 = asset.folder) == null ? void 0 : _a2.id);
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsxs)(RelativeBox, { hasRadius: true, background: "neutral150", borderColor: "neutral200", children: [
      ...
      (0, import_jsx_runtime.jsx)(ActionRow, { paddingLeft: 3, paddingRight: 3, justifyContent: "flex-end", children: (0, import_jsx_runtime.jsxs)(Flex, { gap: 1, children: [
        ...
        canUpdate && ((_a = asset.mime) == null ? void 0 : _a.includes(AssetType.Image)) && (0, import_jsx_runtime.jsx)(
          IconButton,
          {
...
var ReplaceMediaButton = ({
  ...
  const handleChange = () => {
    var _a, _b;
    const file = (_b = (_a = inputRef.current) == null ? void 0 : _a.files) == null ? void 0 : _b[0];
    onSelectMedia(file);
  };
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
...
var EditAssetContent = ({
  ...
  const handleSubmit = async (values) => {
    ...
    const nextAsset = { ...asset, ...values, folder: (_a2 = values.parent) == null ? void 0 : _a2.value };
    if (asset == null ? void 0 : asset.isLocal) {
      ...
      const didChangeLocation = ((_c = asset == null ? void 0 : asset.folder) == null ? void 0 : _c.id) ? asset.folder.id !== ((_d = values.parent) == null ? void 0 : _d.value) : (asset == null ? void 0 : asset.folder) === null && !!((_e = values.parent) == null ? void 0 : _e.value);
                  ...
                  blocks: [
                    {
                      ...
                      value: formatBytes(asset == null ? void 0 : asset.size)
                    },
                    {
                      label: formatMessage({
                    ...
                    },
                    {
                      ...
                      value: formatDate(new Date(asset == null ? void 0 : asset.createdAt))
                    },
                    {
                      label: formatMessage({
                    ...
                    },
                    {
                      ...
                      value: asset == null ? void 0 : asset.id
                    }
                  ]
                }
              ),
          ...
          (0, import_jsx_runtime.jsxs)(Flex, { gap: 2, children: [
            ...
            (0, import_jsx_runtime.jsx)(
              Button,
              {
                onClick: () => {
                  var _a2;
                  return (_a2 = submitButtonRef.current) == null ? void 0 : _a2.click();
                },
                loading: isLoading,
                disabled: formDisabled,
...
var EditFolderContent = ({
  ...
  const initialFormData = !folderStructureIsLoading ? {
    ...
    parent: {
      ...
      label: parentFolderId ? folderStructure && ((_a = findRecursiveFolderByValue(folderStructure, parseInt(parentFolderId.toString(), 10))) == null ? void 0 : _a.label) : folderStructure == null ? void 0 : folderStructure[0].label
    }
  } : {
    name: "",
    parent: null
  ...
  const handleSubmit = async (values, { setErrors }) => {
    ...
    try {
      await editFolder(
        {
          ...values,
          parent: ((_a2 = values.parent) == null ? void 0 : _a2.value) ?? null
        },
...
var AudioAssetCard = ({
  ...
  return (0, import_jsx_runtime.jsx)(AssetCardBase, { name: name2, selected, ...restProps, variant: "Audio", children: (0, import_jsx_runtime.jsx)(CardAsset, { size, children: (0, import_jsx_runtime.jsx)(AudioPreviewWrapper$1, { size, children: (0, import_jsx_runtime.jsx)(AudioPreview, { url, alt: name2 }) }) }) });
};
...
var DocAssetCard = ({
  ...
  return (0, import_jsx_runtime.jsx)(
    AssetCardBase,
    {
      ...
      ...restProps,
      variant: "Doc",
      children: (0, import_jsx_runtime.jsx)(CardAsset2, { width: "100%", height: size === "S" ? `8.8rem` : `16.4rem`, justifyContent: "center", children: (0, import_jsx_runtime.jsx)(IconWrapper$1, { children: extension === "pdf" ? (0, import_jsx_runtime.jsx)(ForwardRef$3f, { "aria-label": name2 }) : (0, import_jsx_runtime.jsx)(ForwardRef$3j, { "aria-label": name2 }) }) })
    }
  );
};
var ImageAssetCard = ({
...
var VideoPreview = ({
  ...
  const handleTimeUpdate = (e) => {
    ...
    if (e.currentTarget.currentTime > 0) {
      ...
      (_a = canvas.getContext("2d")) == null ? void 0 : _a.drawImage(video, 0, 0, video.videoWidth, video.videoHeight);
...
var AssetCard = ({
  ...
  if ((_e = asset.mime) == null ? void 0 : _e.includes(AssetType.Audio)) {
...
var Draggable = ({ children, id, index: index22, moveItem }) => {
      ...
      if (onChangeFolder) {
        return (0, import_jsx_runtime.jsx)(
          CrumbLink,
          {
            ...
            children: typeof crumb.label !== "string" && ((_a = crumb.label) == null ? void 0 : _a.id) ? formatMessage(crumb.label) : crumb.label
          },
...
var SortPicker = ({ onChangeSort, value }) => {
  ...
  return (0, import_jsx_runtime.jsx)(
    SingleSelect,
    {
      ...
      children: sortOptions$1.map((filter) => (0, import_jsx_runtime.jsx)(SingleSelectOption, { value: filter.value, children: formatMessage({ id: getTrad(filter.key), defaultMessage: `${filter.value}` }) }, filter.key))
    }
  );
};
...
var CellContent = ({ cellType, contentType, content, name: name2 }) => {
  ...
  switch (cellType) {
    ...
    case "ext":
      ...
      if (typeof contentValue === "string") {
        return (0, import_jsx_runtime.jsx)(Typography, { children: (_a = getFileExtension(contentValue)) == null ? void 0 : _a.toUpperCase() });
      }
    case "text":
      if (typeof contentValue === "string") {
...
var FilterTag = ({ attribute, filter, onClick, operator, value }) => {
  ...
  const content = `${(_a = attribute.metadatas) == null ? void 0 : _a.label} ${formatMessage({
    ...
    const nextFilters = appliedFilters.filter((prevFilter) => {
      ...
      if (filterName !== void 0) {
        ...
        if (typeof filterValue === "string") {
          ...
          return ((_a = prevFilter[name2]) == null ? void 0 : _a[filterType]) !== decodedValue;
        }
      }
      return true;
    });
    ...
    if (encodedValue) {
      if (modifiedData.name === "mime") {
        ...
        if (modifiedData.value === "file") {
          ...
          if (modifiedData.filter === "$contains") {
            hasCurrentFilter = alreadyAppliedFilters.find((filter) => {
              var _a, _b, _c, _d;
              if (typeof ((_a = filter.mime) == null ? void 0 : _a.$not) !== "string" && !Array.isArray((_b = filter.mime) == null ? void 0 : _b.$not)) {
        ...
        const filtersWithoutFile = filters.filter((filter) => {
          ...
          if (typeof ((_a = filter.mime) == null ? void 0 : _a.$not) !== "string" && !Array.isArray((_b = filter.mime) == null ? void 0 : _b.$not) && ((_d = (_c = filter.mime) == null ? void 0 : _c.$not) == null ? void 0 : _d.$contains) !== void 0) {
            return false;
          }
          if (Array.isArray((_e = filter == null ? void 0 : filter.mime) == null ? void 0 : _e.$contains)) {
            return false;
          }
          return true;
        });
      ...
      const hasFilter = filters.find((filter) => {
        ...
        return filter[modifiedDataName] && ((_a = filter[modifiedDataName]) == null ? void 0 : _a[modifiedDataName]) === encodedValue;
      }) !== void 0;
      if (!hasFilter) {
    ...
    (0, import_jsx_runtime.jsx)(Box, { children: (0, import_jsx_runtime.jsx)(
      SingleSelect,
      {
        ...
        children: displayedFilters2.map((filter) => {
          var _a;
          return (0, import_jsx_runtime.jsx)(SingleSelectOption, { value: filter.name, children: (_a = filter.metadatas) == null ? void 0 : _a.label }, filter.name);
        })
      }
    ) }),
    (0, import_jsx_runtime.jsx)(Box, { children: (0, import_jsx_runtime.jsx)(
...
var FromComputerForm = ({
  ...
  const handleChange = () => {
    var _a;
    const files2 = (_a = inputRef.current) == null ? void 0 : _a.files;
    const assets = [];
    if (files2) {
...
var index2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./index-DCAQ4hHN-EY3ZY4OJ.js"),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      to: "media-library",
      Component: () => import("./index-BWIqjWzC-S5QPNV4E.js"),
...
cropperjs/dist/cropper.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XVOILKE5.js.map
