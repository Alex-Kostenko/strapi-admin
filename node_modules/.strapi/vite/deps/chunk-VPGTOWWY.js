...
// node_modules/@strapi/plugin-documentation/node_modules/@strapi/admin/dist/admin/index-DbsOttc5.mjs
...
// node_modules/@strapi/plugin-documentation/node_modules/@strapi/admin/dist/admin/useEnterprise-BGzVPL4w.mjs
...
var getEERoutes$1 = () => window.strapi.isEE ? [
  {
    ...
    lazy: async () => {
      const { AuthResponse } = await import("./AuthResponse-BKpQdQAD-OH24PAKH.js");
      return {
...
var HistoryProvider = ({ children }) => {
  ...
  const [state, dispatch] = React2.useReducer(reducer$12, {
    history: [],
    currentLocationIndex: 0,
    currentLocation: "",
    canGoBack: false
  });
  const isGoingBack = React2.useRef(false);
  const pushState = React2.useCallback((path) => {
    dispatch({
      type: "PUSH_STATE",
      payload: typeof path === "string" ? { to: path, search: "" } : path
    });
  }, []);
  const goBack = React2.useCallback(() => {
    navigate(-1);
    dispatch({ type: "GO_BACK" });
    isGoingBack.current = true;
  }, [navigate]);
  const prevIndex = React2.useRef(state.currentLocationIndex);
  React2.useEffect(() => {
...
var BackButton = React2.forwardRef(({ disabled }, ref) => {
...
var App = ({ strapi, store }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Providers, { strapi, store, children: (0, import_jsx_runtime.jsx)(import_react.Suspense, { fallback: (0, import_jsx_runtime.jsx)(Page.Loading, {}), children: (0, import_jsx_runtime.jsx)(Outlet, {}) }) });
};
var useClipboard = () => {
...
var BaseHeaderLayout = React2.forwardRef(
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-DU7ilx-j-B2LB7G32.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-CRc63lEC-LFIXY6UK.js");
        return {
...
var Form2 = React2.forwardRef(
  ({ disabled = false, method, onSubmit, initialErrors, ...props }, ref) => {
    ...
    const setErrors = React2.useCallback((errors) => {
      dispatch({
        type: "SET_ERRORS",
        payload: errors
      });
    }, []);
    const setValues = React2.useCallback((values) => {
      dispatch({
        type: "SET_VALUES",
        payload: values
      });
    ...
    const addFieldRow = React2.useCallback(
    ...
    const removeFieldRow = React2.useCallback(
      (field, removeAtIndex) => {
        dispatch({
    ...
    const moveFieldRow = React2.useCallback(
    ...
    const setSubmitting = React2.useCallback((isSubmitting) => {
...
var MemoizedInputRenderer = (0, import_react.memo)(InputRenderer);
var Img = dt.img`
  height: 7.2rem;
`;
var Logo = () => {
...
var Login = ({ children }) => {
  const [apiError, setApiError] = React2.useState();
  const { formatMessage } = useIntl();
  const { search: searchString } = useLocation();
  const query = React2.useMemo(() => new URLSearchParams(searchString), [searchString]);
  const navigate = useNavigate();
...
var NpsSurvey = () => {
  ...
  const [isFeedbackResponse, setIsFeedbackResponse] = React2.useState(false);
  ...
  const [surveyIsShown, setSurveyIsShown] = React2.useState(
    checkIfShouldShowSurvey(npsSurveySettings)
  );
  const [displaySurvey, setDisplaySurvey] = React2.useState(false);
  React2.useEffect(() => {
...
var Register = ({ hasAdmin }) => {
  const { toggleNotification } = useNotification();
  const navigate = useNavigate();
  const [submitCount, setSubmitCount] = React2.useState(0);
  const [apiError, setApiError] = React2.useState();
...
var AuthPage = () => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import("./Login-pPw_kUht-46U63OMI.js")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-Ch2AsS4W-R3YD6CNI.js")).FORMS,
    {
  ...
  return (0, import_jsx_runtime.jsx)(Component, { hasAdmin });
};
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-D11EprUI-K3DZJ5CN.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-D8Y9v1JU-IPZ7JWN3.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-aqidMECk-DA53VCND.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-BP5lXq97-53WBNE3X.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-C4L-xAko-7BNWAJ3M.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-gW8SAPYF-O5H62U6B.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-DTcwVvA3-HGTSBAT7.js").then((n) => n.b);
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-HjXFncNB-7RVJ2WHK.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-B8zLIUiJ-OI4VTJNY.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-C6V54HVw-LOF4OAMU.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-Do_ImfQP-TYCFV7UK.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-MT-w83JE-JSQJL2AG.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-CQaXmC5W-PWCFKNBZ.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-D9TEOcxi-CD7IR5ZT.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-DXwCSuWk-NFMZCEJT.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-C-RwP8VY-OADOGNGL.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-DVI2-no2-SU7IIUNM.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-PG_jndS0-XSMPDMOQ.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-CFJWZM9Y-LCW2R3Q6.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-BL-_luUe-FR34CFRI.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-DiGt5ghr-UVUHLLY5.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-BQLP8OM0-E5MNDNPM.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-eSG4mx_w-EYVBEUX7.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-BGHGSh-L-TAHNNWNT.js");
              return {
  ...
  async loadAdminTrads() {
    const adminLocales = await Promise.all(
      this.configurations.locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/en-GB.js": () => import("./en-GB-D81NWpkp-NLO63ENA.js") }), `./translations/${locale}.js`, 3);
          return { data, locale };
        } catch {
          try {
            const { default: data } = await __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/ar.json": () => import("./ar-7vbwrPth-KEMVLVTK.js"), "./translations/ca.json": () => import("./ca-f06Q0InB-H6DPFBZ2.js"), "./translations/cs.json": () => import("./cs-DrRkodPD-JQRUNPPQ.js"), "./translations/de.json": () => import("./de-D0NA2abW-UAJ26MAF.js"), "./translations/dk.json": () => import("./dk-Cv0jDfcZ-ODQJRAE5.js"), "./translations/en.json": () => import("./en-BwH0BITJ-RGYFML7O.js"), "./translations/es.json": () => import("./es-t8XFZqIM-TNIBCM64.js"), "./translations/eu.json": () => import("./eu-CDMMTSys-RURM6SYZ.js"), "./translations/fr.json": () => import("./fr-CKlZ-5Zr-3BTLOY7L.js"), "./translations/gu.json": () => import("./gu-CSS25C49-H4GGDS27.js"), "./translations/he.json": () => import("./he-C3w9omDw-2PC2YK3V.js"), "./translations/hi.json": () => import("./hi-DW2CutdA-Y6SIRCLB.js"), "./translations/hu.json": () => import("./hu-DaDd6FHR-E4SYIU2X.js"), "./translations/id.json": () => import("./id-cH3Ovozx-NKDFNF6X.js"), "./translations/it.json": () => import("./it-T1rZP3NX-GUDJ43G4.js"), "./translations/ja.json": () => import("./ja-Cc9Dg_QK-W6QEKGDM.js"), "./translations/ko.json": () => import("./ko-D1e-SMHS-D6JLWS75.js"), "./translations/ml.json": () => import("./ml-FLft_QIc-P7YYJ46J.js"), "./translations/ms.json": () => import("./ms-eMDSLvhl-L25NIJ3L.js"), "./translations/nl.json": () => import("./nl-CubaFTJw-M4PNF7Z6.js"), "./translations/no.json": () => import("./no-9TbSG07o-6K27362C.js"), "./translations/pl.json": () => import("./pl-B0hZgHvQ-4MWE2RDO.js"), "./translations/pt-BR.json": () => import("./pt-BR-BDpWvCrQ-PWSW5LYQ.js"), "./translations/pt.json": () => import("./pt-8dwKSOn3-7K7HMVR4.js"), "./translations/ru.json": () => import("./ru-C34i9wJx-UJSYX6MI.js"), "./translations/sa.json": () => import("./sa-CHD-r_h--IBIZ3NAU.js"), "./translations/sk.json": () => import("./sk-DQ2qpsG2-DOOMFWW7.js"), "./translations/sv.json": () => import("./sv-D0vPVUAT-ZIES4ZCP.js"), "./translations/th.json": () => import("./th-BG3IOCqV-JUOZ5OW3.js"), "./translations/tr.json": () => import("./tr-Dq45DRRZ-SJQOEVSU.js"), "./translations/uk.json": () => import("./uk-Ud9QNfkB-FHWPYOAS.js"), "./translations/vi.json": () => import("./vi-CGrr4ioy-KHRNYVBY.js"), "./translations/zh-Hans.json": () => import("./zh-Hans-C44LvcXE-RQNE6E45.js"), "./translations/zh.json": () => import("./zh-LqPg8hbL-Y5EAIZCP.js") }), `./translations/${locale}.json`, 3);
            return { data, locale };
          } catch {
...
var useForceUpdate = () => {
  const [tick, update] = React2.useState();
  const isMounted = useIsMounted();
  const forceUpdate = React2.useCallback(() => {
...
var useThrottledCallback = (callback, wait, options) => {
  const throttledCallback = (0, import_react.useMemo)(
...
var DescriptionComponentRenderer = ({
  ...
  const statesRef = React2.useRef({});
  const [tick, forceUpdate] = useForceUpdate();
  const requestHandle = React2.useRef(null);
  const requestUpdate = React2.useCallback(() => {
  ...
  const ids2 = React2.useMemo(
    () => descriptions.map((description) => getCompId(description)),
    [descriptions]
  );
  const states = React2.useMemo(
    () => ids2.map((id) => {
      var _a;
...
var useShallowCompareEffect = (callback, dependencies) => {
  React2.useEffect(callback, useShallowCompareMemoize(dependencies));
};
var BASE_FILTERS = [
  {
...
var SearchInput = ({
  ...
  const iconButtonRef = React2.useRef(null);
  const [{ query }, setQuery] = useQueryParams();
  const [value, setValue] = React2.useState((query == null ? void 0 : query._q) || "");
  const [isOpen, setIsOpen] = React2.useState(!!value);
  const { formatMessage } = useIntl();
  const { trackUsage } = useTracking();
...
//# sourceMappingURL=chunk-VPGTOWWY.js.map
